  ...
  <q-dialog v-model="openLog" persistent backdrop-filter="brightness(60%)" full-width full-height>
    <q-card class="dialogBg">
      ...
      <q-card-section class="q-ml-sm">
        <div class="card-title" style="font-size: 34px;color: white!important;">{{ t("logs.realtimeLogs") }}
        </div>
      ...
      <q-scroll-area ref="scrollArea" class="q-pa-md q-ml-auto q-mr-auto"
        style="height:70vh;width: 90vw;background-color:#444444;color: #C0C0C0;font-family: monospace;">
